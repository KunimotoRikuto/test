...
# ハイパラ、基本設定群
path = "C:\\Users\\1500570\\Documents\\R\\WS\\dataset_3class_stayzone2"
data = csv.reader(open(path+"\\data12_sc.csv","r"))
...
while i <= term_m:
    ...
    tes_x = []
    k = 1
    # kをn_data-i-goal*2+「2」まで回すのは、はみ出した分をテストデータに格納する処理を同時にやるため
